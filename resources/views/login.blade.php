      ...
      <div class="col-lg">
        <div class="c-text-about-p justify-content-center pt-lg-5 pt-sm-4">
          ...
          <div class="d-flex pt-3">
            ...
            <div>
              <a href="https://timeline.line.me/user/_dbhqzOurXL1CbjNxhYBPzSbYBVWZFDnFa5_ashs" target="_blank"><img class="social-icon mt-2" src="{{ asset('/assets/line.png') }}" alt="ig"></a>
            </div>
            <div>
